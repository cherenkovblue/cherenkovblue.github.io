...
$.getJSON(url, function(data) {
  ...
  ** for (var i = 0; i < entry.length; i++) {
  ...
  if ($.urlParam('id') != null) {
    ...
    html += '      <h3>#' + entry[$.urlParam('id') - 1]['gsx$id']['$t'] + '</h3>';
    html += '    </div>';
    ...
    html += '      <a href="#"><i class="fa fa-envelope fa-2x" aria-hidden="true"></i></a>&nbsp;&nbsp;';
    html += '      <a href="#"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>&nbsp;&nbsp;';
    html += '      <p>&nbsp</p>';
    html += '    </div>';
    html += '  </div>';
    html += '</div>';
    ...
    for (var i = entry.length - 1; i >= 0; i -= 1) {
      ...
      html += '      <p>&nbsp</p>';
      html += '    </div>';
      html += '    <div class="content-bottom text-center">';
